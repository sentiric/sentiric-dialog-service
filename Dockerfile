...
RUN CGO_ENABLED=0 GOOS=linux go build \
    ...
    -o /app/bin/sentiric-dialog-service ./cmd/dialog-service
...
COPY --from=builder /app/bin/sentiric-dialog-service .
RUN chown appuser:appgroup ./sentiric-dialog-service
